...
{
  std::vector<std::string> paramNames{
    "Input", "Threshold", "Bass", "Middle", "Treble", "Output", "NoiseGateActive", "ToneStack", "OutNorm", "IRToggle", "BassFrequency", "MiddleFrequency", "TrebleFrequency", "showFrquencySliders", "followTrackColor"};
  int pos = _UnserializePathsAndExpectedKeys(chunk, startPos, config, paramNames);
  // Then update:
...
{
  std::vector<std::string> paramNames{
    "Input", "Gate", "Bass", "Middle", "Treble", "Output", "NoiseGateActive", "ToneStack", "OutNorm", "IRToggle", "BassFrequency", "MiddleFrequency", "TrebleFrequency", "showFrquencySliders", "followTrackColor"};
